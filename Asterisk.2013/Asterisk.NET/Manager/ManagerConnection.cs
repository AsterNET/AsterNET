...
namespace AsterNET.Manager
{
    ...
    public class ManagerConnection
    {
        ...
        /// <summary>
        /// Allows you to specify how events are fired. If false (default) then
        ...
        /// </summary>
        /// <param name="hostname">the hostname of the Asterisk server to connect to.</param>
        ...
        /// if set to <b>false</b> then all unassigned events lost and send only UnhandledEvent.<br/>
        /// Default: <b>false</b>
        /// </summary>
